...
SELECT 
  cta_section.id,
  'titulo',
  '{"texto": "Venha Fazer Parte da Nossa Comunidade"}'::jsonb,
  1
FROM cta_section
UNION ALL
SELECT 
  cta_section.id,
  'paragrafo', 
  '{"texto": "Descubra o amor de Deus e encontre sua família espiritual conosco."}'::jsonb,
  2
FROM cta_section
UNION ALL
SELECT 
  cta_section.id,
  'botao',
  '{"texto": "Saiba Mais", "url": "/sobre"}'::jsonb,
  3
FROM cta_section;