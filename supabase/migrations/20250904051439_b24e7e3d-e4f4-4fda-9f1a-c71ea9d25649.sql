-- ===================================================================
-- CORREÇÃO: RECRIAR FUNÇÃO COM NOMENCLATURA CORRETA  
-- ===================================================================

-- Dropar função existente com problema
DROP FUNCTION IF EXISTS public.calcular_saude_celula(uuid);
...
BEGIN
  -- Calcular média de presenças usando nome correto da coluna 'presencas'
  ...
  RETURN COALESCE(pontuacao_final, 0);
END;
$$;