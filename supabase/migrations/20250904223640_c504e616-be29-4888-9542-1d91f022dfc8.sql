...
CREATE TABLE IF NOT EXISTS public.notificacoes_escala (
  ...
  escala_membro_id UUID REFERENCES public.escalas_membros(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_notificacoes_escala_membro_id ON public.notificacoes_escala(escala_membro_id);
